...
<html lang="en">
    <head>
        ...
        <title>Loreon Learning Platform</title>
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        ...
                        $dbUser = getenv('DB_USER') ?: 'learninguser';
                        $dbPassword = getenv('DB_PASSWORD') ?: 'learningpassword';
                ...
                <div class="col-md-3 col-sm-6 business_content">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p><?php echo $row['Description'] ?> <span>Duration: <?php echo $row['Duration'] ?></span></p>
                        </div>
                    </div>
                </div>
        ...
        <footer class="footer_area row">
            <div class="container custom-container">
                <div class="copy_right_area">
                    <h4 class="copy_right">© Copyright 2025 Loreon Learning Platform | All Rights Reserved</h4>
                </div>
            </div>
        </footer>
